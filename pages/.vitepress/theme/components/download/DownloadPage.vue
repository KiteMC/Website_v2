...
.download-btn.language { display: grid; grid-template-columns: auto auto; justify-content: center; align-items: center; width: 100%; min-height: 34px; padding: 0.4rem 0.75rem; border: 0 !important; border-radius: 6px; background: var(--vp-c-brand-soft); color: var(--vp-c-text-1); font-size: 0.78rem; text-align: center; box-shadow: none !important; }
...
.history-language-packs { display: grid; grid-template-columns: repeat(2, minmax(0, 1fr)); gap: 0.45rem; align-self: stretch; position: relative; left: 0; right: auto; width: 100% !important; max-width: 100% !important; min-width: 0; box-sizing: border-box; margin: 0.75rem 0 0 !important; transform: none !important; border: 0 !important; outline: 0 !important; box-shadow: none !important; overflow: hidden; }
